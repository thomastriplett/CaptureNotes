...
public class EditActivity extends AppCompatActivity {
    ...
    public void whenUpdateDocTaskIsDone(String resultDocId) {
        ...
        saveNote(editText.getText().toString(), resultDocId);
    }
    ...
    private void saveNote(String recording) {
        ...
        if (noteid == -1) {
            dbHelper.saveNotes(username, title, content, date, "None");
        } else {
            dbHelper.updateNote(username, date, title, content, "None", originalTitle);
        }
